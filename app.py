# -*- coding: utf-8 -*-
"""7_Despliegue_video_juegos.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1WxdHAaBwx0hUT99BP2e9MBseab_hJrUB
...
#Cargamos los datos futuros
#data = pd.read_csv("./sample_data/videojuegos-datosFuturos.csv")
#data.head()
...
#Se normaliza la edad para predecir con Knn, Red, SVM,NN
...
#Hacemos la predicción con el NN
